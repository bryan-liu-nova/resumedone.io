    ...
    return (
      ...
      <div className="b-section-steps">
        <div className="b-section-steps__inner">
          ...
          <div className="b-section-steps__list b-list-examples b-list-examples_style_3">
            <div className="b-list-examples__inner c-slick-examples c-slick-examples_style_2">
              {templates.map((t, i) => (
