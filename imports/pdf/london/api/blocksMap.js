...
import PercentageDisplay from '/imports/pdf/london/ui/components/PercentageDisplay';
import SocialLinkDisplay from '/imports/pdf/london/ui/components/SocialLinkDisplay';
import RangeActivityDisplay from '/imports/pdf/london/ui/components/RangeActivityDisplay';
import ReferenceItem from '/imports/pdf/london/ui/components/ReferenceItem';
import { Text } from '/imports/pdf/london/ui/atoms';
...
export default {
  ...
  'LANGUAGES': {
    ...
    canDisplay(languages) {
      return languages.items.some(item => item.fields != null && item.fields.language);
    },
    renderItem(item, resume, isPlaceholder) {
      ...
      return (
        <PercentageDisplay
            key={item._id}
            title={this.getItemTitle(item)}
            percentage={item.fields.languageLevel}
  ...
  'SKILLS': {
    ...
    canDisplay(skills) {
      return skills.items.some(item => item.fields != null && item.fields.skill);
    },
    renderItem(item, resume, isPlaceholder) {
      ...
      return (
        <PercentageDisplay
            key={item._id}
            title={this.getItemTitle(item)}
            percentage={item.fields.skillLevel}
            color={resume.settings.color}
