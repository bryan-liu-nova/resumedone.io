...
class SetPasswordPage extends PureComponent {
  ...
  componentDidMount() {
    window.analytics.track('set_password_view');
  }
  ...
  onSubmit = (e) => {
    ...
    Accounts.resetPassword(token, password, () => {
      localStorage.setItem('resumedone:password-set', 'true');
      ...
      <PageExt>
        ...
        <ContainerComp>
          <PageHeadings
              ...
              subtitle="Please type in your new password. We don't ask you to confirm that because we believe in you:D"
          />
          <ContentSection>
            <Flex>
